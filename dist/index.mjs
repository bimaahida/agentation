...
import { useState as useState7, useCallback as useCallback5, useEffect as useEffect6, useLayoutEffect, useRef as useRef6, version as reactVersion } from "react";
...
var LEGACY_EVENT_DELEGATION = parseInt(reactVersion, 10) < 17;
